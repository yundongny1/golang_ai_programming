...
with(anscombe, print(predict(lm(y1 ~ x1, data = anscombe))))
with(anscombe, print(predict(lm(y2 ~ x2, data = anscombe))))
with(anscombe, print(predict(lm(y3 ~ x3, data = anscombe))))
with(anscombe, print(predict(lm(y4 ~ x4, data = anscombe))))
